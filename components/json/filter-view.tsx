      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center space-x-2">
          <Switch
            ...
            onCheckedChange={checked => setOptions({ ...options, includeParents: checked })}
          />
        ...
        <div className="space-y-2">
          ...
          <Input 
            ...
            onChange={e => setOptions({ ...options, maxDepth: parseInt(e.target.value) || undefined })}
          />
        </div>
        ...
        <div className="space-y-4">
          ...
          {options.conditions?.map((cond, index) => (
            <div key={index} className="flex items-center space-x-2">
              <span className="text-sm">{cond.key} {cond.operator} {cond.value}</span>
              <Button
                variant="ghost"
                size="sm"
          ...
          <div className="grid grid-cols-2 gap-2">
            <Input 
              placeholder="Key"
              value={condition.key}
              onChange={e => setCondition({ ...condition, key: e.target.value })}
            />
            <Input 
              placeholder="Value"
